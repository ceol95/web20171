<!-- left menu - menu ben  trai	 -->
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li id="danhmuc"><a href="{!!url('admin/nhanhieu')!!}"><svg class="glyph stroked map"><use xlink:href="#stroked-map"/></svg> Nhãn hiệu</a></li>
			<li id="danhmuc"><a href="{!!url('admin/nhacungcap')!!}"><svg class="glyph stroked desktop"><use xlink:href="#stroked-desktop"/></svg> Nhà cung cấp</a></li>
