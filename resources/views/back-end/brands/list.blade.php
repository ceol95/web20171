		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">
						<div class="col-md-12">
							<a href="{!!url('admin/nhanhieu/add')!!}" title=""><button type="button" class="btn btn-primary pull-left btn-add"><i class="fa fa-plus" aria-hidden="true"></i>Thêm Mới</button></a>
							...
							<tbody>
								<tr>
									...
									<tr>
										...
										<td>{!!$row->name!!}</td>
										<td>
											<a href="{!!url('admin/nhanhieu/edit/'.$row->id)!!}" title="Sửa"><span class="glyphicon glyphicon-edit"></span> </a>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="{!!url('admin/nhanhieu/del/')!!}" class="btn btn-primary btn-Del">Xóa</a>
