<div class="footer">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="payment"><img src="{!!url('public/front-end/images/payment.png')!!}" alt="" class="img-responsive"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script src="{!!url('public/front-end/js/jquery.nivo.slider.pack.js')!!}"></script>
