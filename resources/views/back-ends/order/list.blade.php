...
<div class="row">
	<div class="col-xs-12">
		...
		<a href="{!!url('admin/sanpham/add')!!}" class="btn btn-primary">Thêm mới</a>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="{!!url('admin/donhang/del/')!!}" class="btn btn-primary btn-Del">Xóa</a>
    ...
    jQuery(function($) {
    	...
    	var parent_column = $(grid_selector).closest('[class*="col-"]');
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 280,
					colNames:[' ','', 'ID','Khách hàng','Địa chỉ', 'Điện thoại','Email','Ngày đặt','Thành tiền','Trạng thái'],
					colModel:[
					...
					formatoptions:{ 
						...
						{name:'',index:'', width:60, sorttype:"int", editable: true,
							formatter: function (cellValue, options, rowObject) {
							    return "<a href='donhang/detail/"+rowObject.id+"' ><i class='fa fa-pencil' aria-hidden='true'></i></a>"
						...
						{name:'phone',index:'phone', width:90,  resizable: true},
						{name:'note',index:'note', width:90,  resizable: true},
						{name:'created_at',index:'created_at', width:90,sorttype:"date", editable: false,formatter:"date"},
						{name:'total',index:'total', width:90,align:'right',  resizable: true,formatter:'currency', 
							formatoptions:{decimalSeparator:",", thousandsSeparator: ",", decimalPlaces: 0, prefix: ""},sorttype:"float"},
						{name:'status',index:'status', width:90,  resizable: true,
							formatter: function (cellValue, options, rowObject) {
							    if(cellValue=='0') return "Chưa xác nhận"; else return "Đã xác nhận";
							} },
