...
<form class="form-horizontal" action="" method="POST" role="form" enctype="multipart/form-data" onsubmit="return validate()">
	...
	<div class="row">
		...
		<div class="col-md-10">
			<div class="col-md-5">
				<div align="center" >
					<img id="daiDien" src="{!!url('public/uploads/products/'.$pro->images)!!}" style=" width:320px;height:200px;" /> <br />
					<input type="file" name="txtimg" accept="image/*" id="inputtxtimg" value="{!!url('public/uploads/products/'.$pro->images)!!}" class="form-control"  onchange="file_change(this)"  style="display: none">
				</div>
			...
			<div class="col-md-7">
				<div class="row">
					<div class="form-group col-md-12">
						...
						<input type="text" name="txtname" required id="inputtxtname" class="form-control" value="{!! old('txtname',isset($pro['name']) ? $pro['name'] : null) !!}"  >
					</div>	
					<div class="form-group col-md-6">
						<label for="input-id">Chọn danh mục</label>
						<select name="sltCate" id="inputSltCate" required class="form-control" value="{!! old('sltCate',isset($pro['cat_id']) ? $pro['cat_id'] : null) !!}">
					...
					<div class="form-group col-md-6">
						...
						<select name="sltBrand" id="inputsltBrand" required class="form-control" value="{!! old('sltBrand',isset($pro['brand_id']) ? $pro['brand_id'] : null) !!}">
				...
				<div class="row">
					...
					<div class="form-group col-md-6" >
						...
						<input type="text" name="txtpacket" id="inputtxtpacket" class="form-control" value="{!! old('txtpacket',isset($pro['packet']) ? $pro['packet'] : null) !!}" required="required">
					</div>	
				</div>
				<div class="row">
					<div class="form-group col-md-12" >
						<label for="input-id">Tag :</label>  
						<input type="text" name="txttag" id="inputtag" value="{!! old('txttag',isset($pro['tag']) ? $pro['tag'] : null) !!}" class="form-control">
					</div>	
				</div>
			</div>
		</div>
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group col-md-12">
						...
						<input type="number" name="txtprice" id="inputtxtprice" class="form-control" value="{!! old('txtprice',isset($pro['price']) ? $pro['price'] : null) !!}" required="required">
					</div>	
					<div class="form-group col-md-12">
						<label for="input-id">Giá khuyến mãi</label>
						<input type="number" name="txtPromo" id="inputtxtPromo" class="form-control" value="{!! old('txtPromo',isset($pro['promotionPrice']) ? $pro['promotionPrice'] : null) !!}"  >
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group col-md-12" >
						...
						<input type="text" name="txtpromo1" id="inputtxtpromo1" value="{!! old('txtpromo1',isset($pro['promo1']) ? $pro['promo1'] : null) !!}" class="form-control" >
					</div>
					<div class="form-group col-md-12" >
						<label for="input-id">Khuyến mãi 2 :</label>  
						<input type="text" name="txtpromo2" id="inputtxtpromo2" value="{!! old('txtpromo2',isset($pro['promo2']) ? $pro['promo2'] : null) !!}" class="form-control" >
					</div>	
				</div>
				<div class="row">
					<div class="form-group col-md-12" >
						<label for="input-id">Khuyến mãi 3 :</label>  
						<input type="text" name="txtpromo3" id="inputtxtpromo3" value="{!! old('txtpromo3',isset($pro['promo3']) ? $pro['promo3'] : null) !!}" class="form-control" >
					</div>	
				</div>
			</div>
		</div>
						...
						<div class="row" style="padding-top: 10px;">
							...
							<div class="form-group col-md-4">
								...
								<a value="Chọn ảnh" onclick="document.getElementById('inputtxtimg'+{!!$i!!}).click()" >
									@if($i<count($pro->detail_img))
									<img id="chitiet{!!$i!!}" src="{!!url('public/uploads/products/details/'.$pro->detail_img[$i]->images_url)!!}"  class="img-detail"/>
									@else
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group">
						...
						<textarea name="txtre_Intro" id="inputTxtre_Intro" class="form-control" value="{{ old('txtre_Intro') }}" rows="2" required="required">{!! old('txtre_Intro',isset($pro->r_intro) ? $pro->r_intro : null) !!}</textarea>
						
					</div>
					<div class="form-group">
						<label for="input-id">Bài viết chi tiết</label>
						<textarea name="txtReview" id="inputtxtReview" class="form-control" rows="4" value="{{ old('txtReview') }}" required="required">{!! old('txtReview',isset($pro->review) ? $pro->review : null) !!}</textarea>
...
<script type="text/javascript">
	$( document ).ready(function() {
    	$('#inputsltBrand option[value="'+{!! old('sltBrand',isset($pro['brand_id']) ? $pro['brand_id'] : null) !!}+'"]').attr('selected', 'selected');
    	$('#inputSltCate option[value="'+{!! old('sltCate',isset($pro['cat_id']) ? $pro['cat_id'] : null) !!}+'"]').attr('selected', 'selected');
    	$('#inputSltType option[value="'+{!! old('sltType',isset($pro['seo']) ? $pro['seo'] : null) !!}+'"]').attr('selected', 'selected');
    	$('#inputSltStatus option[value="'+{!! old('sltStatus',isset($pro['status']) ? $pro['status'] : null) !!}+'"]').attr('selected', 'selected');
