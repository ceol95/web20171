...
<div class="row">
	<div class="col-xs-12">
		...
		<a href="{!!url('admin/news/add')!!}" class="btn btn-primary">Thêm mới</a>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="{!!url('admin/news/del/')!!}" class="btn btn-primary btn-Del">Xóa</a>
				...
				jQuery(grid_selector).jqGrid({
					...
					formatoptions:{ 
						...
						{name:'images',index:'images',resizable:true, width:40,
							formatter: function (cellValue, options, rowObject) {
							    return "<img src='{!!url('public/uploads/news/"+cellValue+"')!!}'  width='50' height='40'>";
							} },
