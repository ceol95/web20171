		...
		<div class="col-md-10">
			<div class="col-md-5">
				<div align="center" >
					...
					<input type="file" name="txtimg" accept="image/*" id="inputtxtimg" value="{{ old('txtimg') }}" class="form-control" required="required" onchange="file_change(this)" required style="display: none">
				</div>
			...
			<div class="col-md-7">
				<div class="row">
					<div class="form-group col-md-12">
						...
						<input type="text" name="txtTitle" required id="inputTxtTitle" class="form-control" value="{{ old('txtTitle') }}"  >
					</div>	
					<div class="form-group col-md-12">
