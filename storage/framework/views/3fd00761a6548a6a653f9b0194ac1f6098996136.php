...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo url('public/images/logo.png'); ?>" alt="logo" width="50" height="20">
    ...
    <?php /* <link href="<?php echo url('public/bootstrap/css/ie10-viewport-bug-workaround.css'); ?>" rel="stylesheet"> */ ?>

    <!-- Custom styles for this template -->
    <link href="<?php echo url('public/front-end/front-end-style.css'); ?>" rel="stylesheet">
    <link rel='stylesheet' id='camera-css'  href="<?php echo url('public/css/camera.css'); ?>" type='text/css' media='all'>
    <link rel='stylesheet' id='camera-css' href="<?php echo url('public/css/cam-1.css'); ?>" type='text/css' media='all'>

    <link href="<?php echo asset('css/blueimp-gallery.css'); ?>" rel="stylesheet">
    <!-- <link rel='stylesheet' id='camera-css'  href='public/css/camera.css' type='text/css' media='all'>  -->

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <?php /* <script type='text/javascript' src="<?php echo url('public/bootstrap/js/ie-emulation-modes-warning.js'); ?>"></script> */ ?>
    <script type='text/javascript' src="<?php echo url('public/js/ads.js'); ?>"></script> 
