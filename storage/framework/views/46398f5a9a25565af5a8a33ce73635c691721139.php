...
<div class="row">
	<div class="col-xs-12">
		...
		<a href="<?php echo url('admin/news/add'); ?>" class="btn btn-primary">Thêm mới</a>
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="<?php echo url('admin/news/del/'); ?>" class="btn btn-primary btn-Del">Xóa</a>
		...
		var parent_column = $(grid_selector).closest('[class*="col-"]');
				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 300,
					colNames:[' ','', 'ID','Ảnh','Tiêu đề','Danh mục','Tóm tắt','Ngày tạo'],
					colModel:[
					...
					formatoptions:{ 
						...
						{name:'',index:'', width:40, sorttype:"int", editable: true,
							formatter: function (cellValue, options, rowObject) {
							    return "<a href='news/edit/"+rowObject.id+"' ><i class='fa fa-pencil' aria-hidden='true'></i></a>"
						...
						{name:'images',index:'images',resizable:true, width:40,
							formatter: function (cellValue, options, rowObject) {
							    return "<img src='<?php echo url('public/uploads/news/"+cellValue+"'); ?>'  width='50' height='40'>";
							} },
						{name:'title',index:'title', width:150, resizable: true},
						{name:'cat_id',index:'cat_id', width:90,  resizable: true},
						{name:'intro',index:'intro', width:150,  resizable: true},
