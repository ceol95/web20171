					...
					<?php endif; ?>
						<form action="" method="POST" role="form" enctype="multipart/form-data">
				      		...
				      		<div class="form-group">
				      			...
				      			<input type="text" name="txtTitle" id="inputTxtTitle" class="form-control" value="<?php echo e(old('txtTitle')); ?>"  >
				      		</div>
				      		<div class="form-group">
				      			<div class="row">
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      				Tác giả : <input type="text" name="txtAuth" id="inputTxtAuth" class="form-control" value="<?php echo e(old('txtAuth')); ?>" required="required">
					      			</div>
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				      		...
				      		<div class="form-group">				      			
				      			<div class="row">
					      			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
					      				Hình ảnh : <input type="file" name="txtimg" accept="image/*" id="inputtxtimg" value="<?php echo e(old('txtimg')); ?>" class="form-control" required="required">
					      			</div>					      		
					      			...
					      			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
					      				Nguồn tin : <input type="text" name="txtSource" id="inputtxtSource" value="<?php echo e(old('txtSource')); ?>" class="form-control">
					      			</div>
					      		</div>				      			
				      		</div>
				      		<div class="form-group">
