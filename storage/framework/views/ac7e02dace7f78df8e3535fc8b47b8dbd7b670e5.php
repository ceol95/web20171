				...
				*/
				...
				jQuery(grid_selector).jqGrid({
					...
					formatoptions:{ 
						...
						{name:'phone',index:'phone', width:90, editable: true,editrules:{custom_func:phoneCheck}},
						{name:'codeTax',index:'codeTax', width:90, editable: true},
						{name:'email',index:'email', width:90, editable: true,editrules:{custom_func:emailCheck}},
				...
				//jQuery(grid_selector).jqGrid('hideCol',["codeTax","email"]);
