		...
		<div class="col-md-10">
			<div class="col-md-5">
				<div align="center" >
					...
					<input type="file" name="txtimg" accept="image/*" id="inputtxtimg" value="<?php echo e(old('txtimg')); ?>" class="form-control"  onchange="file_change(this)"  style="display: none">
				</div>
			...
			<div class="col-md-7">
				<div class="row">
					<div class="form-group col-md-12">
						...
						<input type="text" name="txtname" required id="inputtxtname" class="form-control" value="<?php echo e(old('txtTitle')); ?>"  >
					</div>	
				...
				<div class="row">
					<div class="form-group col-md-6" >
						...
						<input type="text" name="txtintro" id="inputtxtintro" class="form-control" value="<?php echo e(old('txtAuth')); ?>" required="required">
					</div>
					<div class="form-group col-md-6" >
						<label for="input-id">Gồm có :</label>  
						<input type="text" name="txtpacket" id="inputtxtpacket" class="form-control" value="<?php echo e(old('txtAuth')); ?>" required="required">
					</div>	
				</div>
				<div class="row">
					<div class="form-group col-md-12" >
			...
			<div class="col-md-12">
				<div class="row">
					<div class="form-group col-md-12">
						...
						<input type="number" name="txtprice" id="inputtxtprice" class="form-control" value="<?php echo e(old('txtprice')); ?>" required="required">
					</div>	
					<div class="form-group col-md-12">
						<label for="input-id">Giá khuyến mãi</label>
						<input type="number" name="txtPromo" id="inputtxtPromo" class="form-control" value="<?php echo e(old('txtPromo')); ?>"  >
					</div>
				</div>
				...
				<div class="row">
					<div class="form-group col-md-12" >
						...
						<input type="text" name="txtpromo1" id="inputtxtpromo1" value="<?php echo e(old('txtpromo1')); ?>" class="form-control" >
					</div>
					<div class="form-group col-md-12" >
						<label for="input-id">Khuyến mãi 2 :</label>  
						<input type="text" name="txtpromo2" id="inputtxtpromo2" value="<?php echo e(old('txtpromo2')); ?>" class="form-control" >
					</div>	
				</div>
				<div class="row">
					<div class="form-group col-md-12" >
						<label for="input-id">Khuyến mãi 3 :</label>  
						<input type="text" name="txtpromo3" id="inputtxtpromo3" value="<?php echo e(old('txtpromo3')); ?>" class="form-control" >
					</div>	
				</div>
			</div>
		</div>
